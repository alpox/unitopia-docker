...
MUD-Client vornehmen:
   ...
   zeichensatz auto[matisch]
   zeichensatz liste
   zeichensatz
      Damit kannst Du die Kodierung von Sonderzeichen vom Client einstellen.
      Bei Angabe von 'automatisch' wird der Zeichensatz des MUD-Clients
      abgefragt (nur wenige MUD-Clients unterstuetzen dies). Mit 'liste'
      erhaeltst Du eine kurze Liste ueblicher Kodierungen.
